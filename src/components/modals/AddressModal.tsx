                            ...
                            <div className="space-y-4 sm:space-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <InputField
                                        ...
                                        onChange={form.setField('addressName')}
                                        required
                                        placeholder={t(
                                    ...
                                    <SearchableSelect
                                        label={t('country')}
                                        value={location.state.selectedCountry}
                                        onChange={(v) =>
                                            location.dispatch({
                                                type: 'SET_COUNTRY',
                                                value: v,
                                    ...
                                    <SearchableSelect
                                        ...
                                        disabled={location.isLoadingDistricts}
                                    />
                                    <InputField
                                        label={t('street')}
                                    ...
                                    <InputField
                                        ...
                                        onChange={form.setField('postalCode')}
                                    />
                                    <InputField
