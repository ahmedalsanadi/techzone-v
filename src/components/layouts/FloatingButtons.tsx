    ...
    return (
        <div>
            ...
            <div className="fixed bottom-4 md:bottom-40 end-2 md:end-8 flex flex-col gap-2 md:gap-4 z-40 pointer-events-none">
                ...
                <button className="w-12 h-12 bg-[#F04E30] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform cursor-pointer pointer-events-auto shadow-red-500/20">
